...
project = 'SandPaper'
copyright = ('2017, {__author__}').format(**PACKAGE)
...
htmlhelp_basename = 'SandPaperdoc'
...
latex_documents = [
    (master_doc, 'SandPaper.tex', 'SandPaper Documentation',
     'Stephen Bunn', 'manual'),
]
...
man_pages = [
    (master_doc, 'sandpaper', 'SandPaper Documentation',
     [author], 1)
]
